...
class DealersControllerTest < ActionController::TestCase
  ...
  test "should create dealer" do
    assert_difference('Dealer.count') do
      post :create, dealer: { address: @dealer.address, contact: @dealer.contact, name: @dealer.name, telephone: @dealer.telephone }
    end
  ...
  test "should update dealer" do
    patch :update, id: @dealer, dealer: { address: @dealer.address, contact: @dealer.contact, name: @dealer.name, telephone: @dealer.telephone }
    assert_redirected_to dealer_path(assigns(:dealer))
  end
